...
//        }
    ...
    public List<FreeBill> pageBill(ISecuritySession securitySession, String wenyBankID, int limit, long offset) throws CircuitException {
        ...
        String ports = site.getProperty("ports.oc.wybank.bill.free");
        ...
        return new Gson().fromJson(json, new TypeToken<ArrayList<FreeBill>>() {
        }.getType());
    }
...
//        demandBankOwner(securitySession, wenyBankID);
    ...
    @Override
    public List<FreeBill> pageBillOfMonth(ISecuritySession securitySession, String wenyBankID, int order, int year, int month, int limit, long offset) throws CircuitException {
        OkHttpClient client = (OkHttpClient) site.getService("@.http");
